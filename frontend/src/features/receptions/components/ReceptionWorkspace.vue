...
.reception-workspace{box-sizing:border-box;flex:1;margin:0;max-width:none;padding:14px 20px 0}.reception-foot{position:sticky;right:auto;bottom:0;left:auto;margin-top:14px;padding:10px 0;background:#f1f3f5}
</style>
