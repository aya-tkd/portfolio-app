...
.reception-workspace{box-sizing:border-box;display:flex;flex:1;flex-direction:column;min-height:0;margin:0;max-width:none;padding:14px 20px 0}.reception-layout{flex:1;min-height:0;overflow:auto}.reception-foot{position:static;right:auto;bottom:auto;left:auto;flex:0 0 auto;margin-top:14px;padding:10px 0;background:#f1f3f5}
</style>
